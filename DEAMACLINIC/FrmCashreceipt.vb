...
Public Class FrmCashreceipt
    ...
    Private Sub BtnAddservice_Click(sender As Object, e As EventArgs) Handles BtnAddservice.Click
        ...
        ElseIf txtservice.Text = "" Then
            MsgBox("PLEASE SELECT SERVICE", MsgBoxStyle.Critical, "CASH RECEIPT")
        Else
        ...
        Next
            If check = False Then
                ...
                GetTotalCost()
            Else
                MsgBox("ITEM IS ALREADY ADDED", MsgBoxStyle.Information, "CASH RECEIPT")
                txtservice.Focus()
            End If
        End If
            ...
            For Each row As DataGridViewRow In DtgServices.Rows
                ...
                Using con As New SqlConnection(Constring)
                    ...
                    Using cmd As New SqlCommand("INSERT INTO RECEIPTS VALUES(@Dat, @Tim, @Rnum, @Fname, @Hnum, @Amnt, @Serv, @CollBY)", con)
                        ...
                        cmd.Parameters.Add("@Tim", SqlDbType.VarChar).Value = dtime.Value.TimeOfDay  '/lbltime.Text
                        ...
                        '     cmd.Parameters.Add("@Serv", SqlDbType.VarChar).Value = DtgServices.CurrentRow.Cells(0).Value
    ...
    Public Sub SaveToTempID()
        ...
        Try
            ...
            For Each row As DataGridViewRow In DtgServices.Rows
                ...
                Using con As New SqlConnection(Constring)
                    Using cmd As New SqlCommand("INSERT INTO Temporary_ID VALUES(@IDs, @Date, @Time, @Pname, @TemID, @Serv, @Amt, @RsBy )", con)
                        ...
                        cmd.Parameters.Add("@Time", SqlDbType.VarChar).Value = dtime.Value '/lbltime.Text
