        ...
        ElseIf Txtpass.Text = "" Then
            ...
            Else
                ...
                Try
                    ...
                    cmd.CommandText = "insert into Admitted values ('" & Lbladmitid.Text & "', '" & Dtdate.Value & "', '" & dtTime.Value.ToShortTimeString & "', '" & Txthospnum.Text & "', '" & txtsname.Text & "', '" & TxtOname.Text & "', '" & Txtsex.Text & "', '" & Txtage.Text & "', '" & Txtdiag.Text & "', '" & Txtinstr.Text & "', '" & Txtadmtyp.Text & "', '" & cboward.Text & "', '" & cbobedno.Text & "', '" & Lbluser.Text & "', '" & Txtcons.Text & "', '" & Txtclinic.Text & "', '" & Lblstatus.Text & "')"
