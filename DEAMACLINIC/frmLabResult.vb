...
Public Class frmLabResult
    ...
    Public Sub LoadPatientTest()
        ...
        cmd = New SqlCommand("Select Test_Name, Payment_Status FROM AllLABBilled  Where Request_Num=@Rqnum", con)
    ...
    Public Sub LoadWhoReview()
        ...
        If tabls.Rows.Count() > 0 Then
            ...
            lblreviewby.Text = tabls.Rows(0)(18).ToString()
    ...
    Private Sub BtnReview_Click(sender As Object, e As EventArgs) Handles BtnReview.Click
        If txtpwordrev.Text = "" Then
            ...
            MsgBox("PLEASE ENTER YOUR PASSWORD", MsgBoxStyle.Critical, "LAB TEST REVIEW")
            txtpwordrev.Focus()
        Else
