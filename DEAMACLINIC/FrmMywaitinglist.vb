...
Public Class FrmMywaitinglist
    Private Sub TabMylist_TabIndexChanged(sender As Object, e As EventArgs) Handles TabMylist.TabIndexChanged
        LoadDocPendLIst()
    ...
    Public Sub LoadDocPendLIst()
        ...
        cmd = New SqlCommand("Select * from Pend_WaitingList WHERE See_Doctor = @Doc AND Date BETWEEN @datfrom AND @datto", con)
    ...
    Public Sub LoadDocTreatedList()
        ...
        cmd = New SqlCommand("Select * from Treated_Waitinglist WHERE Consultation_By = @Doc AND Date BETWEEN @datfrom AND @datto", con)
    ...
    Private Sub btnfindpt_Click(sender As Object, e As EventArgs) Handles btnfindpt.Click
        ...
        cmd = New SqlCommand("Select * from Pend_WaitingList where Hospital_No=@Hospi_No", con)
    ...
    Private Sub btngetpt_Click(sender As Object, e As EventArgs) Handles btngetpt.Click
        ...
        cmd = New SqlCommand("Select * from Treated_Waitinglist where Hospital_No=@Hospital_Num", con)
    ...
    Private Sub Dtgmypendlist_CellDoubleClick(sender As Object, e As DataGridViewCellEventArgs) Handles Dtgmypendlist.CellDoubleClick
        ...
        FrmPtRecords.Txtbp.Text = Dtgmypendlist.CurrentRow.Cells(8).Value.ToString
        FrmPtRecords.txttemp.Text = Dtgmypendlist.CurrentRow.Cells(9).Value.ToString
        FrmPtRecords.txtheight.Text = Dtgmypendlist.CurrentRow.Cells(12).Value.ToString
        FrmPtRecords.txtpulse.Text = Dtgmypendlist.CurrentRow.Cells(10).Value.ToString
        FrmPtRecords.txtweight.Text = Dtgmypendlist.CurrentRow.Cells(11).Value.ToString
        FrmPtRecords.txtresp.Text = Dtgmypendlist.CurrentRow.Cells(13).Value.ToString
