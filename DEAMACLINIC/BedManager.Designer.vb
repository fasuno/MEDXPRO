...
Partial Class BedManager
    ...
    Private Sub InitializeComponent()
        ...
        Me.cbobedname.Items.AddRange(New Object() {"FEMALE WARD", "MALE WARD", "EMERGENCY WARD", "PAEDIATRICS WARD", "EPU", "VIP WARD", "ISOLATION WARD", "POST NATAL WARD", "NEONATAL WARD", "ICU"})
