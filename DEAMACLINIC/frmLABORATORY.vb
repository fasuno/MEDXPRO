...
Public Class frmLABORATORY
    ...
    Public Sub SortPendlabBill()
        ...
        cmd = New SqlCommand("Select * from Pend_LABBill WHERE Date BETWEEN @datefrom AND @dateto", con)
    ...
    Private Sub DtgPendLabReqst_CellDoubleClick(sender As Object, e As DataGridViewCellEventArgs) Handles DtgPendLabReqst.CellDoubleClick
        ...
        FrmLabInvRqst.TxtSname.Text = DtgPendLabReqst.CurrentRow.Cells(4).Value.ToString
