...
Public Class FrmDocUpload
    ...
    Public Sub LoadScannefile()
        ...
        cmd.Parameters.Add("@Hosp_Num", SqlDbType.Int).Value = txthospnum.Text
    ...
    Private Sub Dgvfile_CellDoubleClick(sender As Object, e As DataGridViewCellEventArgs) Handles Dgvfile.CellDoubleClick

        Lbldocid.Text = Dgvfile.CurrentRow.Cells(0).Value
        txtdoctiltle.Text = Dgvfile.CurrentRow.Cells(4).Value
        ' txtfilename.Text = Dgvfile.CurrentRow.Cells(5).Value.ToString

        Btnepdate.BringToFront()
    ...
    Private Sub Timer1_Tick(sender As Object, e As EventArgs) Handles Timer1.Tick
        ...
        If ProgressBar1.Value = 100 Then
            ...
            cmd.Parameters.Add("@Hno", SqlDbType.NChar).Value = txthospnum.Text
